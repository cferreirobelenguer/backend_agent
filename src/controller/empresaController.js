...
var controller={
    ...
    actualizarDatos:(req,res)=>{
        //params
        var empleadoNombre=req.params.nomnbre;
        var empleadoApellidos=req.params.apellidos;
        var params=req.body;
        ...
        if(validate_nombre && validate_apellidos && validate_oficio && validate_departamento && validate_fecha && validate_salario && validate_seguridadsocial && validate_telefono){
            empresaModel.find(
        ...
        if(validate_nombre && validate_apellidos && validate_oficio && validate_departamento && validate_fecha && validate_seguridadsocial && validate_salario && validate_telefono){
        //Find and update
        
        cliente.findOneAndUpdate({nombre: empleadoNombre, apellidos:empleadoApellidos},params,{new:true},(err,empleadoUpdate)=>{
            if(err){
               //Error 
                return res.status(200).send({
                    status:'error',
            ...
            return res.status(200).send({
                ...
                message:'La validación no es correcta'
                    ...
                    //there are any employee with this information
                    return res.status(200).send({
                        status:'error',
